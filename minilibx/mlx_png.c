...
int	mipng_fill_img(mlx_imt_glist_t *img, unsigned char *buf, png_info_t *pi)
{
...
int	mipng_data(mlx_imt_glist_t *img, unsigned char *dat, png_info_t *pi)
{
  unsigned int	len;
  int		b_pos;
...
mlx_imt_glist_t	*mlx_int_parse_png(mlx_ptr_t *xvar, unsigned char *fptr, int size)
{
  int		err;
  unsigned char *hdr;
  unsigned char *dat;
